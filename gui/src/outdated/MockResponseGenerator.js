...
export const generateMockResponse = (
  ...
  const codeVariants = [
    ...
    },
    {
      ...
      methods: {
        fieldDeclarations:
          "private final ConcurrentLinkedDeque<Object> elements = new ConcurrentLinkedDeque<>();",
    ...
    },
    {
      ...
      imports: ["import java.util.concurrent.ConcurrentLinkedDeque;"],
      methods: {
        fieldDeclarations:
          "private final ConcurrentLinkedDeque<Object> stack = new ConcurrentLinkedDeque<>();",
    ...
    },
    {
      ...
      methods: {
        fieldDeclarations:
          "private final ConcurrentLinkedDeque<Object> data = new ConcurrentLinkedDeque<>();",
