  ...
  const runDiagnostics = async () => {
    ...
    try {
      ...
      if (error.message.includes("CORS")) {
        ...
        results.corsTest = {
          success: true,
          message: "CORS OK, got network response",
        };
      }
    }
        ...
        {isLoading ? (
          ...
          <div>
            <p style={{ color: "#6b7280", marginBottom: "20px" }}>
              This tool helps diagnose connection issues between the frontend
              and backend.
            </p>
            ...
            >
              ...
              <ul style={{ margin: 0, paddingLeft: "20px", color: "#6b7280" }}>
                ...
                <li>
                  Check if you can access http://localhost:8000/docs directly in
                  your browser
                </li>
