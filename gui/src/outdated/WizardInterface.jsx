...
function WizardInterface() {
  ...
  const handleGenerationProgress = (status) => {
    ...
    if (status.elapsedTime) {
      const serverElapsed = parseFloat(
        status.elapsedTime.replace(" seconds", ""),
      );
  ...
  const handleLQLValidation = async () => {
    ...
    try {
      ...
      if (validationResult.success && validationResult.isValid) {
        ...
        const errorMessage = LQLValidationAPI.formatErrorsForDisplay(
  ...
  const handleSubmit = async () => {
    ...
    console.log(
      "🎯 WIZARD: Starting async generation with detailed payload:",
      payload,
    );

    try {
      const startResponse =
        await AsyncCodeGenerationAPI.startGeneration(payload);
      ...
      setError(
        err.message ||
          "Failed to start generation. Please check if the Python backend is running on port 8000.",
      );
      setProcessingStatus("error");
      setIsLoading(false);
    }
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 1 && (
            ...
            >
              ...
              {lqlValidationResult && !lqlValidationResult.isValid && (
                <div className="mx-auto max-w-4xl bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg mb-4">
                  <h3 className="font-semibold text-lg mb-2">
                    LQL Validation Errors:
                  </h3>
              ...
              {lqlValidationResult && lqlValidationResult.isValid && (
                <div className="mx-auto max-w-4xl bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg mb-4">
                  ...
                  <p className="text-sm">
                    Your LQL interface definition has been validated
                    successfully.
                  </p>
                </div>
              )}
          ...
          {step === 2 && (
            ...
            >
              <h2 className="wizard-heading">
                Prioritize Your Implementation Criteria
              </h2>
              <p
                className="wizard-text mb-6"
                style={{
                  textAlign: "center",
                  width: "100%",
                  maxWidth: "1000px",
              ...
              >
                ...
                implementation. Drag criteria to reorder their importance.
              </p>
                ...
                <div className="min-h-[250px] border-2 border-dashed border-border-panel rounded-md p-6 bg-white bg-opacity-10 text-center">
                  ...
                  >
                    ...
                    <DragOverlay>
                      {activeDragId ? (
                        <div
                          className="p-3 bg-white text-black rounded-lg text-lg shadow-lg ring-2 ring-accent border border-border-panel"
                          style={{
          ...
          {step === 3 && (
            ...
            >
              ...
              >
                Configure the generation time, select AI models, and specify how
                many implementations you want from each source.
              </p>
                      ...
                      {mavenCentralEnabled && (
                        <div style={{ marginLeft: "35px" }}>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setMavenCentralVersions(Number(e.target.value))
                            }
                            style={{
                              width: "60px",
                              padding: "4px",
                  ...
                  <div className="flex flex-col items-center space-y-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <input
                        ...
                        min={(() => {
                          const totalVersions =
                            Object.values(llmVersions).reduce(
                              (sum, count) => sum + count,
                              0,
                            ) +
                        ...
                        onChange={(e) =>
                          setGenerationTimeMinutes(Number(e.target.value))
                        }
          ...
          {step === 4 && (
            ...
            >
              ...
              <p className="wizard-text mb-6">
                Your code is being generated based on your criteria and
